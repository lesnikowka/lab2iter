...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->‚˚·ÓÃÂÚÓ‰‡ToolStripMenuItem->Size = System::Drawing::Size(124, 26);
			...
			this->ÁÌ‡˜ÂÌËˇ“‡·ÎËˆ˚ToolStripMenuItem->Size = System::Drawing::Size(154, 26);
			...
			this->ÚËÔ«‡‰‡˜ËToolStripMenuItem->Size = System::Drawing::Size(101, 26);
			...
			this->ÔÓÏÓ˘¸ToolStripMenuItem->Size = System::Drawing::Size(83, 26);
			...
			this->label6->Text = L"—ÚÓÎ·ˆ˚ 0-100";
			// 
			// MyForm
			// 
...
private: System::Void button2_Click(System::Object^ sender, System::EventArgs^ e) {
	...
	numPage--;
	label6->Text = "—ÚÓÎ·ˆ˚ " + Convert::ToString(numPage * countPages) + "-" + Convert::ToString(min((numPage + 1) * countPages, n + 2));
	drawTable();
}
